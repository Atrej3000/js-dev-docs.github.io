...
> TODO: Add the English lesson body for `functions-advanced/call-apply-decorators`.
...
- Canonical source route: `/uk/docs/functions-advanced/call-apply-decorators`
- Legacy source path: `uk/functions-advanced/call-apply-decorators.html`
