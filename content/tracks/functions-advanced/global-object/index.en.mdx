...
> TODO: Add the English lesson body for `functions-advanced/global-object`.
...
- Canonical source route: `/uk/docs/functions-advanced/global-object`
- Legacy source path: `uk/functions-advanced/global-object.html`
