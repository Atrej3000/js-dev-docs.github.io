...
> TODO: Add the English lesson body for `functions-advanced/arrow-functions-revisited`.
...
- Canonical source route: `/uk/docs/functions-advanced/arrow-functions-revisited`
- Legacy source path: `uk/functions-advanced/arrow-functions-revisited.html`
