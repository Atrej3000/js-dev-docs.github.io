...
> TODO: Add the English lesson body for `object-properties/property-accessors`.
...
- Canonical source route: `/uk/docs/object-properties/property-accessors`
- Legacy source path: `uk/object-properties/property-accessors.html`
