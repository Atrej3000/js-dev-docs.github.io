...
> TODO: Add the English lesson body for `data-types/iterables`.
...
- Canonical source route: `/uk/docs/data-types/iterables`
- Legacy source path: `uk/data-types/iterables.html`
