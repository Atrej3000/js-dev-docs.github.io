...
> TODO: Add the English lesson body for `data-types/keys-values-entries`.
...
- Canonical source route: `/uk/docs/data-types/keys-values-entries`
- Legacy source path: `uk/data-types/keys-values-entries.html`
