...
> TODO: Add the English lesson body for `prototypes/native-prototypes`.
...
- Canonical source route: `/uk/docs/prototypes/native-prototypes`
- Legacy source path: `uk/prototypes/native-prototypes.html`
