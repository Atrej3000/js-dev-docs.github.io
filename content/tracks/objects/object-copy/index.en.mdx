...
> TODO: Add the English lesson body for `objects/object-copy`.
...
- Canonical source route: `/uk/docs/objects/object-copy`
- Legacy source path: `uk/objects/object-copy.html`
