...
> TODO: Add the English lesson body for `objects/object-basics`.
...
- Canonical source route: `/uk/docs/objects/object-basics`
- Legacy source path: `uk/objects/objects.html`
