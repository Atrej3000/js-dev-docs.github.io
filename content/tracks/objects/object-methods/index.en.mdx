...
> TODO: Add the English lesson body for `objects/object-methods`.
...
- Canonical source route: `/uk/docs/objects/object-methods`
- Legacy source path: `uk/objects/this.html`
