...
> TODO: Add the English lesson body for `objects/garbage-collection`.
...
- Canonical source route: `/uk/docs/objects/garbage-collection`
- Legacy source path: `uk/objects/garbage-collection.html`
