...
> TODO: Add the English lesson body for `promises/promise-basics`.
...
- Canonical source route: `/uk/docs/promises/promise-basics`
- Legacy source path: `uk/promises/promise-basics.html`
