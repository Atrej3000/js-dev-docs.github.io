...
var NAV = [
  { id: 'introduction', articles: [
    { n: '1.1',  id: 'intro'                    },
    { n: '1.2',  id: 'specifications'            },
    { n: '1.3',  id: 'code-editors'              },
    { n: '1.4',  id: 'devtools'                  },
  ]},
  { id: 'basics', articles: [
    ...
    { n: '2.7',  id: 'type-conversions'          },
    { n: '2.8',  id: 'operators'                 },
    { n: '2.9',  id: 'comparison'                },
    { n: '2.10', id: 'conditionals'              },
  ...
  { id: 'code-quality', articles: [
    ...
    { n: '3.3',  id: 'comments'                  },
    { n: '3.4',  id: 'ninja-code'                },
    { n: '3.5',  id: 'testing-mocha'             },
    { n: '3.6',  id: 'polyfills'                 },
  ]},
  { id: 'objects', articles: [
    { n: '4.1',  id: 'object-basics'             },
    { n: '4.2',  id: 'object-copy'               },
    { n: '4.3',  id: 'garbage-collection'        },
    { n: '4.4',  id: 'object-methods'            },
  ...
  { id: 'prototypes', articles: [
    ...
    { n: '8.4',  id: 'proto-methods'             },
  ]},
  { id: 'classes', articles: [
    { n: '9.1',  id: 'class'                     },
    { n: '9.2',  id: 'class-inheritance'         },
    { n: '9.3',  id: 'static-properties'         },
    { n: '9.4',  id: 'private-protected'         },
    { n: '9.5',  id: 'extending-built-in'        },
    { n: '9.6',  id: 'instanceof'                },
    { n: '9.7',  id: 'mixins'                    },
  ]},
