...
;(function (global) {
  ...
  var UK_LOCALE = {
    ...
    ui: {
      ...
      search_trigger:      'Пошук',
      theme_label:         'Змінити тему',
      hero_brand:          'JS Dev Docs',
      hero_title:          'Українська бібліотека для тих, хто вивчає JavaScript серйозно.',
      hero_desc:           '156+ статей, 14 розділів і локальний прогрес без акаунта — від першого script до async generators.',
      hero_cta_primary:    'Почати читати',
      hero_cta_secondary:  'Переглянути розділи',
      learning_eyebrow:    'Ваш ритм',
      learning_heading:    'Читання, яке пам’ятає, де ви зупинилися.',
      learning_desc:       'Сайт зберігає локальний прогрес, останні відкриті теми й допомагає повернутися до навчання без акаунта і зайвого шуму.',
      catalog_eyebrow:     'Каталог',
      catalog_heading:     'Усі розділи перед очима.',
      catalog_desc:        'Фільтруй теми, переходь у потрібний розділ і читай курс як довідник або як послідовний маршрут.',
      filter_placeholder:  'Фільтрувати: promise, closure, class…',
      catalog_empty_title: 'Нічого не знайдено',
      catalog_empty_desc:  'Спробуйте коротший запит або інший термін. Пошук працює за назвами статей, розділами та ключовими словами.',
      stat_articles:       'статей',
      stat_sections:       'розділів',
      support_eyebrow:     'Підтримати проєкт',
      support_heading:     'Допоможіть JS Dev Docs рости швидше.',
      support_desc:        'Це некомерційний волонтерський проєкт. Донат покриває хостинг, редактуру й нові переклади статей для україномовних розробників.',
